...
alias kfc="rusty; kfin $FIN_DIR/prices.tsv | stamp > /tmp/prices.tsv; mv /tmp/prices.tsv $FIN_DIR/prices.tsv; cat $FIN_DIR/prices.tsv; git add $FIN_DIR/prices.tsv; cd -"
