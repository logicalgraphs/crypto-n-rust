...
CMC_TOP_5K_URL=$(GIT_RAW)/data-files/csv/alles/cmc_listings.csv
MY_PORTFOLIO_QUOTES_URL=$(GIT_RAW)/data-files/csv/portfolio/my_portfolio.csv
MAKE_ALLES_URL=https://github.com/logicalgraphs/crypto-n-rust/blob/main/Makefile

MSG_TOP_5K="Top 5000 coins tracked by @CoinMarketCap, ${LE_DATE}"

filter: filterify
	echo "${MSG_TOP_5K}: $(CMC_TOP_5K_URL)"; \
	echo ""; \
	echo "My portfolio coins: $(MY_PORTFOLIO_QUOTES_URL)"; \
	echo ""; \
	echo "Report generated by ./cmc_prices and ./cmc_filter, respectively, run by 'make alles': $(MAKE_ALLES_URL)"; \
	echo ""; \
	echo "This report is archived on my blog at: "; \
	echo ""; \
	echo "<p><a href='$(CMC_TOP_5K_URL)'>$(MSG_TOP_5K)</a></p>"; \
	echo "<p><a href='$(MY_PORTFOLIO_QUOTES_URL)'>My portfolio coins</a>.</p>"; \
	echo "Report generated by ./cmc_prices and ./cmc_filter, respectively, run by '<a href='$(MAKE_ALLES_URL)'>make alles</a>'</p>"; \
	echo ""; \
	echo "daily report,CoinMarketCap,price-quotes"; \
	echo ""; \
	echo "$(LE_DATE) Daily CoinMarketCap Price Quotes"; \
	echo ""
